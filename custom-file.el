...
(custom-set-faces
 ...
 '(ansi-color-blue ((t (:background "#729fdd" :foreground "#729fdd"))))
 '(ansi-color-bright-blue ((t (:background "#a4cbff" :foreground "#a4cbff"))))
 '(ansi-color-bright-green ((t (:background "#57ab5a" :foreground "#57ab5a"))))
 '(ansi-color-bright-red ((t (:background "#d46a76" :foreground "#d46a76"))))
 '(ansi-color-green ((t (:background "#57ab5a" :foreground "#57ab5a"))))
 '(ansi-color-red ((t (:background "#d46a76" :foreground "#d46a76"))))
 '(compilation-mode-line-fail ((t (:inherit compilation-error :weight bold))))
 '(isearch-fail ((t (:background "#d46a76"))))
 '(mode-line ((t (:background "#252525" :foreground "#e1e4e8"))))
 '(mode-line-active ((t (:background "#252525" :foreground "#e1e4e8"))))
 '(mode-line-buffer-id ((t (:foreground "#729fdd"))))
 '(mode-line-inactive ((t (:background "gray12" :foreground "#e1e4e8"))))
 '(org-todo ((t (:foreground "#d46a76" :weight bold))))
 '(region ((t (:extend t :background "gray20" :foreground "white smoke"))))
 '(success ((t (:foreground "#729fdd" :weight bold))))
 '(tabbar-button ((t (:background "#252525" :foreground "#e1e4e8" :slant normal))))
 '(tabbar-default ((t (:background "#252525"))))
 '(tabbar-highlight ((t (:background "#252525" :foreground "#ffa657"))))
 '(tabbar-modified ((t (:background "#252525" :foreground "#729fdd"))))
 '(tabbar-selected ((t (:background "#252525" :foreground "#e1e4e8"))))
 '(tabbar-selected-modified ((t (:background "#252525" :foreground "#d46a76"))))
 '(tabbar-separator ((t (:foreground "#729fdd"))))
 '(tabbar-unselected ((t (:background "#252525" :foreground "#729fdd")))))
